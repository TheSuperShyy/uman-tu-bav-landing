    ...
    <>
      ...
      <div className="fixed bottom-0 inset-x-0 z-50 flex items-center justify-center pb-4 sm:pb-5 pointer-events-none">
        <a
          ...
          className="pointer-events-auto group inline-flex items-center gap-1.5 sm:gap-2 rounded-full border px-3 sm:px-4 py-1 sm:py-1.5 text-[11px] sm:text-xs font-semibold tracking-wide hover:scale-[1.02] backdrop-blur-sm"
        >
          <svg
            viewBox="0 0 24 24"
